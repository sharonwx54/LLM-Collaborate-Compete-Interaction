...
def construct_message(agents, question, idx):
    if len(agents) == 0:
        return  {"role": "user", "content": "Can you double check that your answer is correct. Please reiterate your answer, with your final answer a single paragraph, in the form \\boxed{{answer}}."}
...
if __name__ == "__main__":
    ...
    for data in questions:
        ...
        agent_contexts = [[{"role": "user", "content": """Write a short and coherent story about {topic} that incorporates the answers to the following {num} questions: {questions}. Explain your reasoning. Your final answer should be a single paragraph, in the form \\boxed{{answer}}, at the end of your response. """.format(topic=topic, num=numq, questions=parse_q_list)}] for agent in range(agents)]
    ...
    json.dump(generated_description, open("tcw_{}_{}.json".format(agents, rounds), "w"))
